...
| [`lib/model/featherless_model_client.dart`](lib/model/featherless_model_client.dart)   | The Featherless implementation of `ModelClient`. Uses the OpenAI-compatible Featherless API, builds the A2UI system prompt from your catalog, layers your `prompt.dart` on top, and streams the model's response. This is where the API key and model name live.                                                                                         |
